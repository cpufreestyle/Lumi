...
plutil -replace CFBundleShortVersionString -string "1.1.4" "$APP/Contents/Info.plist"
plutil -replace CFBundleVersion -string "1" "$APP/Contents/Info.plist"
rm -rf "$APP/Contents/_CodeSignature"
rm -f Lumi-v1.1.4.zip
ditto -c -k --keepParent "$APP" Lumi-v1.1.4.zip
ls -lh Lumi-v1.1.4.zip
echo "DONE_ZIP"
